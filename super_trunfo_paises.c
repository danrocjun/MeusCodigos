...
int main(){
    ...
    int card01_populacao; // O número de habitantes da pais
    float card01_area; //  A área da pais em quilômetros quadrados
    float card01_PIB; // O Produto Interno Bruto da pais
    int card01_num_pontos_tur; // : A quantidade de pontos turísticos na pais
    ...
    int card02_populacao; // O número de habitantes da pais
    float card02_area; //  A área da pais em quilômetros quadrados
    float card02_PIB; // O Produto Interno Bruto da pais
    int card02_num_pontos_tur; // : A quantidade de pontos turísticos na pais
    ...
    int seleçao; // seleção do atributo da rodada
...
/*
09/09/25
Seleção do atributo para comparação

*/
//Seleção do atributo para jogar


printf("\n\nEscolha o atribuuto da rodada conforme abaixo:\n");
printf("1.População.\n");
printf("2.Área.\n");
printf("3.PIB.\n");
...
case 1:
  ...
  if (card01_populacao>card02_populacao){
  printf("Para o atributo população  a carta 1 venceu!!\n");
  }else if (card01_populacao<card02_populacao){
  printf("Para o atributo população  a carta 2 venceu!!\n");
  }else if (card01_populacao==card02_populacao){
  printf("Empate!\n");}     
  break; 
  ...
  if (card01_area>card02_area){
  printf("Para o atributo área a carta 1 venceu!!\n");
  }else if (card01_area<card02_area){
  printf("Para o atributo área  a carta 2 venceu!!\n");
  }else if (card01_area==card02_area){
  printf("Empate!\n");}     
  break; 
  ...
  if (card01_PIB>card02_PIB){
  printf("Para o atributo PIB a carta 1 venceu!!\n");
  }else if (card01_PIB<card02_PIB){
  printf("Para o atributo PIB  a carta 2 venceu!!\n");
  }else if (card01_PIB==card02_PIB){
  printf("Empate!\n");}     
  break; 
  ...
  if (card01_num_pontos_tur>card02_num_pontos_tur){
  printf("Para o atributo número de pontos turísticos a carta 1 venceu!!\n");
  }else if (card01_num_pontos_tur<card02_num_pontos_tur){
  printf("Para o atributo número de pontos turísticos  a carta 2 venceu!!\n");
  }else if (card01_num_pontos_tur==card02_num_pontos_tur){
  printf("Empate!\n");}     
  break; 
  ...
  if (card01_densid_pop<card02_densid_pop){
  printf("Para o atributo densidade demográfica a carta 1 venceu!!\n");
  }else if (card01_densid_pop>card02_densid_pop){
  printf("Para o atributo densidade demográfica a carta 2 venceu!!\n");
  }else if (card01_densid_pop==card02_densid_pop){
  printf("Empate!\n");}     
  break; 
 }
